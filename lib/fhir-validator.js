...
(function(fhir) {
	...
	fhir.validate = function(data, expectedType) {
		...
		if(resource && resource.resourceType && fhir.isValidResourceType(resource.resourceType)) {
			if(!expectedType || expectedType === resource.resourceType) {
				var validate = validateResource[resource.resourceType];
				validate(resource);
